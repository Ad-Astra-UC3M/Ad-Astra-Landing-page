...
import jetEngine from "../../assets/bootcamp/calendar/jet_engine.ics";
...
export default function BootcampPage() {
  ...
  const downloadICS = () => {
	...
	return (
		<section
			id="about"
			className="relative overflow-hidden bg-brand-surface px-6 py-40 sm:px-8 md:py-40 lg:py-55"
		...
		>
			...
			<p className="text-3xl mx-auto text-center font-astra-display uppercase tracking-[0.16em] text-brand-ink/95 z-10">
				Unéte a nuestra comunidad de Whatsapp para no perderte nada y guarda las
			...
			<div className="flex items-center justify-center gap-6 mt-8">
				...
				>
						<img src={calendar} alt="Calendario" className="w-20 h-20" />
